<article @php(post_class('h-entry full-width-constrained'))>
    <header class="text-center">
        <div class="pt-20 md:py-30 space-y-12">
            <div>
                @if (is_singular('post'))
                    <a href="/blog">
            ...
            <h1 class="p-name fade-in-bottom text-6xl-fluid font-serif">
                {!! $title !!}
            </h1>
        </div>
        <div class="divide-keyline/80 flex hidden items-center justify-center divide-x text-[19px]">
